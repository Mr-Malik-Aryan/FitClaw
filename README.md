<p align="center">
  <img src="https://lh3.googleusercontent.com/d/1kUBPeqVkbz2pAki-2xGLXs7_GeK09FWn" alt="FitClaw" width="180"/>
</p>

<h1 align="center">FitClaw</h1>
<p align="center">Your 24/7 AI fitness & nutrition coach — personalised, persistent, and fully autonomous.</p>
<p align="center">Powered by <strong>OpenClaw</strong> · Executed by <strong>Swiggy MCP</strong> · Lives in <strong>WhatsApp & Telegram</strong></p>

<p align="center">
  <img src="https://img.shields.io/badge/OpenClaw-Runtime-FF4500?style=flat-square&logo=github&logoColor=white"/>
  <img src="https://img.shields.io/badge/Claude_Opus_4.5-AI_Brain-7B2FBE?style=flat-square"/>
...
### AI Models
<p>
  <img src="https://img.shields.io/badge/Claude_Opus_4.5-Anthropic-7B2FBE?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/GPT--4o_Vision-OpenAI-412991?style=for-the-badge&logo=openai&logoColor=white"/>
</p>

### Swiggy MCP
<p>
  <img src="https://img.shields.io/badge/Swiggy_Food-FC8019?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Instamart-47C24D?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Dineout-E23744?style=for-the-badge"/>
</p>

### Wearables & Health
<p>
  <img src="https://img.shields.io/badge/Oura_Ring-1A1A2E?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/8Sleep-111111?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Google_Fit-4285F4?style=for-the-badge&logo=google&logoColor=white"/>
  <img src="https://img.shields.io/badge/Apple_Health-FF3B30?style=for-the-badge&logo=apple&logoColor=white"/>
  <img src="https://img.shields.io/badge/Fitbit-00B0B9?style=for-the-badge&logo=fitbit&logoColor=white"/>
  <img src="https://img.shields.io/badge/Garmin-007DC3?style=for-the-badge&logo=garmin&logoColor=white"/>
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Cron-OpenClaw-FF4500?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Webhooks-000000?style=for-the-badge"/>
</p>

### Voice & Media
<p>
  <img src="https://img.shields.io/badge/Voice-Whisper_STT-00A67E?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Image_Gen-OpenClaw-FF6F00?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Camera-iOS_%26_Android-333333?style=for-the-badge"/>
</p>
...
```mermaid
graph TB
    subgraph CHANNELS["User Channels — OpenClaw Connectors"]
        WA[WhatsApp]
        TG[Telegram]
        SL[Slack / Discord]
        VOICE[Voice — Whisper]
    ...
    subgraph RUNTIME["OpenClaw Runtime · Self-Hosted Gateway"]
        GW[Gateway · Routing · Sessions]
        MEM[Persistent Memory\nSQLite + Vector Embeddings\nMeals · Workouts · Goals · Preferences]
        CRON[Cron Scheduler\nMorning Brief · Meal Reminders · Weekly Grocery]
        HOOK[Webhooks\nWearable Ingestion]
        LOBSTER[Lobster Workflow Engine\nYAML Multi-Step Pipelines]
    end

    subgraph AI["AI Layer"]
        CLAUDE[Claude Opus 4.5\nNutrition Reasoning · Goal Tracking\nPersonalised Suggestions · Deficiency Detection]
        VISION[GPT-4o Vision\nMeal Photo Analysis · Scale OCR]
    end

    subgraph SKILLS["ClawHub Skills"]
        NUTR[fitclaw-nutrition\nICMR RDA · 22-Nutrient Engine]
        STREAK[fitclaw-streaks\nXP · Badges · Swiggy Rewards]
        IMGGEN[Image Gen · GifGrep]
    end

    subgraph WEARABLES["Wearables & Health"]
        OURA[Oura Ring\nHRV · Sleep · Activity]
        SLEEP[8Sleep\nRecovery Score]
        FIT[Google Fit · Fitbit · Garmin\nSteps · Workouts · Training Load]
        AH[Apple HealthKit\nCalories · Workouts]
    end

    subgraph SWIGGY["Swiggy MCP · Execution Layer"]
        FOOD[Food\nsearch · menu · cart · coupon · order · track]
        INSTA[Instamart\nproducts · go-to-items · cart · checkout]
        DINE[Dineout\nsearch · slots · book]
    end
